...
#define _card_enable()      	GPIO_ResetBits(GPIOB,GPIO_Pin_7)
#define _card_disable()     	GPIO_SetBits(GPIOB,GPIO_Pin_7)
#define _card_power_on()
#define _card_insert()       	GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_11)
